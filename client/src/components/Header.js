    ...
    return (
      <div className='header'>
        ...
        <div className='socialLinks'>
          <a href='https://github.com/rpalmore' rel='noopener noreferrer' target='_blank'>
            <img className='socialIcons' src={github} alt={"Github"}/>
          </a>
          <a href='https://twitter.com/rebeccapalmore' rel='noopener noreferrer' target='_blank'>
            <img className='socialIcons' src={twitter} alt={"Twitter"}/>
          </a>
          <a href='https://linkedin.com/in/rebecca-palmore' rel='noopener noreferrer' target='_blank'>
