          ...
          <div className='sectionContainerInner'>
            <div className='contentContainer'>
             <div className={componentClasses.join(' ')}></div>
                ...
                <p>I’m grateful to feel that I belong in this industry. Now that I’ve landed that first job, I want to encourage other bootcamp students to take that leap of faith. To trust their instincts. To make that bet on themselves.
                </p>
                <p>
