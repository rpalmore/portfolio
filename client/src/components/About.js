          ...
          <div className='sectionContainerInner'>
            <div className='contentContainer'>
             <div className={componentClasses.join(' ')}></div>
                ...
                <p>
                I wasn’t sure what to expect but I also wasn’t new to bootcamps. In 2017, I completed a six-month, part-time course in full-stack development at <a className='effect' href="https://sps.northwestern.edu/" target="_blank" rel="noopener noreferrer">Northwestern University</a>. I had a few interviews after graduating from that program but didn’t feel ready for the big switch. (It didn’t help that I still had a fulfilling job in journalism.) This time, I had to make it work. I was now unemployed and looking to trade in my manager card for a job as a junior&mdash;an associate starting out in a new field.
                </p>
